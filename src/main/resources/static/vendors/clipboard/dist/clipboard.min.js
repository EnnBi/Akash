...
<script type='text/javascript'>
/* <![CDATA[ */
var ajax_auth_object = {"ajaxurl":"https:\/\/www.urbanui.com\/wp-admin\/admin-ajax.php","redirecturl":"\/victory\/vendors\/clipboard\/dist\/clipboard.min.js","loadingmessage":"Please wait..."};
/* ]]> */
</script>
...
<meta name="msapplication-TileImage" content="https://www.urbanui.com/wp-content/uploads/2020/01/cropped-UrbanUI-Favicon-270x270.png" />
  ...
  display: none;
	...
	<body> 
		...
		<h2>Log In</h2>
		<p class="bd-notice"></p>
		<input type="hidden" id="security" name="security" value="576a719f71" /><input type="hidden" name="_wp_http_referer" value="/victory/vendors/clipboard/dist/clipboard.min.js" />  
		<div>
  ...
  <div class="modal lrp-modal" id="regpopup" >
		...
		<h2>Register</h2>
		<p class="bd-notice"></p>
	  <input type="hidden" id="signonsecurity" name="signonsecurity" value="078157f75f" /><input type="hidden" name="_wp_http_referer" value="/victory/vendors/clipboard/dist/clipboard.min.js" />   
    ...
    <p class="bd-notice"></p>  
    <input type="hidden" id="forgotsecurity" name="forgotsecurity" value="249ac3f72e" /><input type="hidden" name="_wp_http_referer" value="/victory/vendors/clipboard/dist/clipboard.min.js" />  
...
Served from: www.urbanui.com @ 2021-03-13 10:16:48 by W3 Total Cache
-->