...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/endors/font-awesome/css/font-awesome.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/vendors/jquery-bar-rating/fontawesome-stars.css">
...
<body>
						...
						<div class="tab-pane fade" id="chats-section" role="tabpanel"
							...
							<ul class="chat-list">
								<li class="list active">
									<div class="profile">
										<img src="${pageContext.request.contextPath}/images/faces/face1.jpg" alt="image"><span
											class="online"></span>
									</div>
									<div class="info">
										<p>Thomas Douglas</p>
								...
								<li class="list">
									<div class="profile">
										<img src="${pageContext.request.contextPath}/images/faces/face2.jpg" alt="image"><span
											class="offline"></span>
									</div>
									<div class="info">
								...
								<li class="list">
									<div class="profile">
										<img src="${pageContext.request.contextPath}/images/faces/face3.jpg" alt="image"><span
											class="online"></span>
									</div>
									<div class="info">
										<p>Daniel Russell</p>
								...
								<li class="list">
									<div class="profile">
										<img src="${pageContext.request.contextPath}/images/faces/face4.jpg" alt="image"><span
											class="offline"></span>
									</div>
									<div class="info">
								...
								<li class="list">
									<div class="profile">
										<img src="${pageContext.request.contextPath}/images/faces/face5.jpg" alt="image"><span
											class="online"></span>
									</div>
									<div class="info">
								...
								<li class="list">
									<div class="profile">
										<img src="${pageContext.request.contextPath}/images/faces/face6.jpg" alt="image"><span
											class="online"></span>
									</div>
									<div class="info">
										<p>Sarah Graves</p>
	...
	<script
		src="${pageContext.request.contextPath}/vendors/jquery-bar-rating/jquery.barrating.min.js"></script>
	...
	<script
		src="${pageContext.request.contextPath}/vendors/jquery-sparkline/jquery.sparkline.min.js"></script>
