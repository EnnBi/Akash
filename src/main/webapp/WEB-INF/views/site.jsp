...
<div class="col-12 grid-margin">
	<div class="card">
		<div class="card-body">
			...
			<form:form action="${action}" modelAttribute="site" method="post">
				<form:hidden path="id" />
...
<div class="col-lg-12 grid-margin">
	<div class="card">
		<div class="card-body">
			<h4 class="card-title">Site Table</h4>
			...
			<div class="table-responsive">
				<table class="table table-striped">
					...
					<c:url var='updatelink' value="/site/edit" />

					<c:url var="deletelink" value="/site/delete" />
					<tbody>
			...
			<ul
				...
				<c:forEach var="i" begin="1" end="${totalPages}">
					<c:choose>
						...
						<c:otherwise>
							<li class="page-item"><a class="page-link"
								href="<c:url value="/site/pageno=${i}"/>">${i}</a></li>
						</c:otherwise>
					</c:choose>
				</c:forEach>
